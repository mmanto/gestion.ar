...
import { GraduationCap, LayoutDashboard, Trash2 } from 'lucide-react';
    ...
    <>
      ...
      {bots.length === 0 ? (
        ...
        <>
          ...
          <Card shadow="none" className="mb-6">
            <h3 className="text-sm font-semibold text-gray-900 mb-1">Honorarios</h3>
            <p className="text-sm text-gray-700 mb-3">
              Monto que el agente informa cuando el cliente pregunta por honorarios. Moneda: peso mexicano (MXN).
            </p>
            <input
              type="text"
              value={facts.honorarios ?? ''}
              onChange={(e) => handleUpdateValue('honorarios', e.target.value)}
