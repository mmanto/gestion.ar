...
// una URL alcanzable desde el dispositivo. El fallback es la URL de prod para
// que un build sin env no hornee un localhost inalcanzable. Mismo patrón que
// VITE_API_URL: valor baked en el bundle.
